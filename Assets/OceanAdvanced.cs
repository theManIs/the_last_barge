...
public class OceanAdvanced : MonoBehaviour
{
  ...
  static Wave[] waves =
  {
    new Wave(99, 100, 1.4f, 0.9f, new Vector2( 1.0f * 55f,  0.2f * -100f)),
    new Wave(60, 1.2f, 0.8f, 0.5f, new Vector2( 1.0f * 55f,  3.0f * -100f)),
    new Wave(20, 3.5f, 0.4f, 0.8f, new Vector2( 2.0f * 55f,  4.0f * -100f)),
    new Wave(30, 2.0f, 0.4f, 0.4f, new Vector2(-1.0f * 55f,  0.0f * -100f)),
    new Wave(10, 3.0f, 0.05f, -100,new Vector2(-1.0f * 55f,  1.2f * -100f))
  };
  ...
  void Awake()
  {
    ...
    for (int i = 0; i < NB_WAVE; i++)
    {
      ...
      v_waves_dir[i] = new Vector4(waves[i].direction.x, waves[i].direction.y, 100, -50);
    }
